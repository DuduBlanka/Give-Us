...
const repeatPasswordInput= document.getElementById("pwd-repeat")
...
//modal
const returnModal = document.getElementById('return_modal_id');
...
function checkInput() {
  ...
  // Get all form fields
    ...
    const repeatEmailField = document.getElementById("email-repeat");
    const phoneNumberField = document.getElementById("phonenumber_id");
    const repeatPhoneNumberField = document.getElementById("phoneNumber-repeat");
