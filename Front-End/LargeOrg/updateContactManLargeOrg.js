...
/////////////////////////////////////////////////////////////////////////////
//form
const formUpDate = document.querySelector(".form-update-box");
...
function scrollToModal() {
  // const modalElement = document.getElementById('result_id'); // Replace 'modal' with the ID of your modal element
...
function checkFields(){
  ...
  if (phoneNumberField.value === "" && repeatPhoneNumberField.value === "" && roleField.value === "") {
