...
const deleteContactManBtn = document.getElementById("deletecontactmanBtn_id");  
...
function resetFormFields() {
    ...
    let selectElement = document.getElementById('contactmanselect_id');
...
function openDeleteContactManModal() {
  if (deleteContactManModal) {
    document.body.classList.add('deleteContactManLargeOrg');
    deleteContactManModal.style.display = 'block';
  }
}
function closeDeleteContactManModal() {
  if (deleteContactManModal) {
    document.body.classList.remove('deleteContactManLargeOrg');
...
// Call the function to display contact man details on page load
//window.addEventListener('load', displayContactManDetails);
