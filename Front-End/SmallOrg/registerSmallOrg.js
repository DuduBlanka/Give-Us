...
/* // Add event listener to form submit button
document.querySelector("form-register-box").addEventListener("submit", function(event) {
  // Prevent form from submitting
    event.preventDefault();
  // Get all form fields
    const fullNameField = document.getElementById("Fullname");
    const emailField = document.getElementById("Email");
    const repeatEmailField = document.getElementById("RepeatEmail");
    const phoneNumberField = document.getElementById("PhoneNumber");
    const repeatPhoneNumberField = document.getElementById("RepeatPhoneNumber");
    const addressField = document.getElementById("Address");
    const cityField = document.getElementById("City");
    const passwordField = document.getElementById("pwd");
    const repeatPasswordField = document.getElementById("pwd-repeat");
...
// Define regex patterns for email and phone validation
  ...
  // Check if all required fields are filled in
    if (fullNameField.value === "" || emailField.value === "" || repeatEmailField.value === "" ||
    ...
    alert("The registration was done successfully")
    // If all checks pass, submit the form
    this.submit();
    document.querySelector(".form-reg-box").submit();

    window.location.href = "smallOrgHomePage.html";
});
 */